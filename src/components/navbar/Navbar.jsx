      ...
      isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"
        ...
        <div className='text-white py-5 flex justify-between items-center'> 
          ...
          <div className='text-lg font-semibold cursor-pointer'>
            ...
            <span className='text-white'>Niño</span>
            <span className='text-[#8245ec]'>/</span>
            <span className='text-white'>Lacambra</span>
            <span className='text-[#8245ec]'>&gt;</span>
          </div>
          ...
          <div className = "hidden md:flex space-x-4">
            <a href="https://github.com/NinoLacambra" target='_blank' rel='noopener noreferrer' className="text-gray-300 hover:text-[#8245ec]">
            <FaGithub size={24}/>
            </a>
            <a href="https://www.linkedin.com/in/niño-lacambra" target='_blank' rel='noopener noreferrer' className="text-gray-300 hover:text-[#8245ec]">
            <FaLinkedin size={24}/>
            </a>
          </div>
